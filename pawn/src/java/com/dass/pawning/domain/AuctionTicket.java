...
import com.dass.core.bean.Consolidate;
import com.dass.core.bean.Trace;
import com.dass.core.bean.TransactionConsolidate;
@Table
@Entity(name="tblauctionticket")
public class AuctionTicket extends Consolidate {
	...
	public String toString() {
		return "AuctionTicket [auctionTicketId=" + auctionTicketId
				+ ", ticketId=" + ticketId + ", auctionId=" + auctionId
				+ ", productId=" + productId + ", assignDate=" + assignDate
				+ ", soldDate=" + soldDate + ", minimumCapital="
				+ minimumCapital + ", minimumInterest=" + minimumInterest
				+ ", soldAmount=" + soldAmount + ", capitalSettled="
				+ capitalSettled + ", interestSettled=" + interestSettled
				+ ", auctionExpences=" + auctionExpences + ", isPaidToClient="
				+ isPaidToClient + ", paidAmount=" + paidAmount
				+ ", isAllocated=" + isAllocated + ", excessAmount="
				+ excessAmount + ", recordStatus=" + ", upsetValue=" + upsetValue + "]";
	}
