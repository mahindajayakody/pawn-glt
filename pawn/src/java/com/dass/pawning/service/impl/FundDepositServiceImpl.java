...
public class FundDepositServiceImpl extends AuthorizableServiceImpl implements FundDepositService {
	...
	public List<Object[]> getTiketAllForTheDay(UserConfig userConfig,Date printDate){
		return fundDepositDAO.getTiketAllForTheDay(userConfig,printDate);
	}
	public List<Object[]> getReceiptAllForTheDay(UserConfig userConfig,Date printDate){
		return fundDepositDAO.getReceiptAllForTheDay(userConfig,printDate);
	}
	public List<Object[]> getFundRequestAllForTheDay(UserConfig userConfig,Date printDate){
		return fundDepositDAO.getFundRequestAllForTheDay(userConfig,printDate);
	}
	public List<Object[]> getFundDepositAllForTheDay(UserConfig userConfig,Date printDate){
		return fundDepositDAO.getFundDepositAllForTheDay(userConfig,printDate);
	}
}
