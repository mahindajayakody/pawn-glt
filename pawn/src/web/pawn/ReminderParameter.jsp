  	...
  	<head>
		...
		<script type="text/javascript">
			...
			function getGridData(){
				data = "dispatch=getAjaxData&conditions=productId<next>schemeId&value=" + $('productId').value + "<next>" + $('schemeId').value;
			...
			function getCreateData(){
				...
				return "&code=" + code + "&description=" + description + "&productCode=" + productCode + "&productId=" + productId +
					   "&schemeId=" + schemeId + "&schemeCode=" + schemeCode + "&isNominee=" + isNominee + "&noOfDays=" + noOfDays;
			}
		...
		<style>
			...
			#firstGrid .aw-column-2 {width: 150px;}
			#firstGrid .aw-column-3 {width: 150px;}
