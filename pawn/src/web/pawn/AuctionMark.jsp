  	...
  	<head>
		...
		<script type="text/javascript"><!--
			...
			function getSerchData(rurl,gridobj){
				...
				{
					/*if($('auctionglobe').value)
					{
						data = "dispatch=getActiveAuction&conditions=status&value=1" + "&conditions=isCommon&value=1";
					}
					else
					{*/
				data = "dispatch=getActiveAuction&conditions=branchId&value=0" /*+ $('branchId').value */ +	"&conditions=status&value=1";
					/*}*/
				}
							...
							<td>
								<script>
	                                ...
	                                gridSerchPrd.onRowDoubleClicked = function(event, row){
										try{
											clearOtherData();
											$('productId').value     = this.getCellText(2,row);
							...
							<tr height="5px"></tr>
								<tr>
									...
									<!--<td width="15%" align="right">
										<bean:message bundle="lable" key="screen.auctionglobe"/>&nbsp;
									</td>
									<td>
										<input type="checkbox" id="auctionglobe" name="auctionglobe" >
										<font color="red">*</font><br/>
										<div id="divAuctionglobe" class="validate"/>
									</td>
								<tr height="5px"></tr>
								--></tr>
