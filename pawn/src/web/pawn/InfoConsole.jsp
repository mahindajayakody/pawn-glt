...
<html:html>
	<head>
		...
		<script type="text/javascript">
			...
			function getInfoData(){
				...
				data = "dispatch=getInforDataForConsolNew&ticketId=" + $('ticketId').value;
				...
				mySearchRequest.callback = function(responseText, responseStatus, responseXML) {
					if (responseStatus==200) {
						...
						$('ticketStatusDesc').value		= message['ticketStatus'];
						$('officername').value			= message['officerName'];
						$('closureDate').value			= message['closureDate'];
						$('auctionStatus').value		= message['auctionStatus'];
			...
			function clearOtherData(){
				...
				$('ticketStatusDesc').value		= '';
				$('auctionStatus').value		= '';
				$('officername').value			= '';
				$('closureDate').value			= '';
				setGridData(gridDue , []);
				setGridData(gridTicket , []);
				setGridData(DueRecGrid, []);
			}
		</script>
		...
		<style>
			...
			#forthGrid .aw-column-0 {width: 150px;}
			#forthGrid .aw-column-1 {width: 80px;text-align: center;}
			#forthGrid .aw-column-2 {width: 80px;text-align: right;}
			#forthGrid .aw-column-3 {width: 80px;text-align: center;}
			#forthGrid .aw-column-4 {width: 180px;}
			#forthGrid .aw-column-5 {width: 80px;text-align: right;}
			...
			#fifthGrid .aw-column-0 {width: 240px;}
	...
	<body>
		...
		<!-- Create record -->
		<logic:equal name="infoconsole" property="action" value="create">
			<html:form action="infoconsoleService.do">
												...
												<td>
													<table cellpadding="0" cellspacing="0">
														<tr>
															...
															<td>
																<input property="ticketStatusDesc" Id="ticketStatusDesc" size="15" readonly="readonly" class="READONLYINPUT" />
															</td>
															<td style="width: 250px" align="right">
																<bean:message bundle="lable" key="screen.closedate" />&nbsp;
															</td>
															<td>
																<input property="closureDate" Id="closureDate" size="10" readonly="readonly" class="READONLYINPUT" />
															</td>
															<td style="width: 250px" align="right">
																<bean:message bundle="lable" key="screen.auction.status" />&nbsp;
															</td>
															<td>
																<input property="auctionStatus" Id="auctionStatus" size="15" readonly="readonly" class="READONLYINPUT" />
															</td>															
														</tr>
							...
							<table class="InputTable">
								...
								<tr>
									...
									<td>
										...
										<input type="text" size="57" maxlength="100" id="clientName" readonly="readonly" class="READONLYINPUT" />
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" size="71" id="clientAddress" readonly="readonly" class="READONLYINPUT" />
									</td>
								</tr>
								<tr height="2px"></tr>
							</table>
												...
												<td>
													<table cellpadding="0" cellspacing="0">
														<tr>
															...
															<td>
																<input property="officername" Id="officername" size="20" readonly="readonly"
																	class="READONLYINPUT" />
															</td>
														</tr>
													</table>
									...
									<td colspan="4" align="center">
										<script>
											var myColumns = ["<bean:message bundle="lable" key="screen.article"/>",
															 ...
															 "<bean:message bundle="lable" key="screen.assedvalue"/>",
				...
				<table class="toolTable" id="toolbar">
					<tr>
						<td align="right">
							<input type="button" value="<bean:message bundle="button" key="button.clear"/>" id="Clear" class="buttonNormal"
								onclick="clearAll();" />
						</td>
					</tr>
				</table>
