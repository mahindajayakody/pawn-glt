...
<html:html>
  	<head>
		...
		<script type="text/javascript">								
			...
			var url = 'ticketStatusService.do';	
		...
		<style>
			#firstGrid {height: 420px;width:720px;}
			...
			#authorizeGrid {height: 420px;width:720px;}
  	...
  	<body onload="loadToolBar()">
    	...
    	<!-- Create record -->
    	<logic:equal name="ticketstatus" property="action" value="create">
			<html:form action="ticketStatusService.do">
    	...
    	<!-- update record -->
    	<logic:equal name="ticketstatus" property="action" value="update">
			<html:form action="ticketStatusService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="code" styleId="code" size="6" maxlength="4" readonly="true" styleClass="READONLYINPUT"
											onblur="upperCase('code')" onfocus="clearDivision('divCode')"/>										
											<font color="red">*</font><br/>
											<div id="divCode" class="validate"/>
									</td>
    	...
    	<!-- Delete record -->
    	<logic:equal name="ticketstatus" property="action" value="delete">
			<html:form action="ticketStatusService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
    	...
    	<!-- Authorize record -->
    	<logic:equal name="ticketstatus" property="action" value="authorize">
			<html:form action="ticketStatusService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="description" styleId="description" size="70" maxlength="50" readonly="true" styleClass="READONLYINPUT"
											onfocus="clearDivision('divDescription')"/>										
										<font color="red">*</font><br/>
										<div id="divDescription" class="validate"/>
									</td>
